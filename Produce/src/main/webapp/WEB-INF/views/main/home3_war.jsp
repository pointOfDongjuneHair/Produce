        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            ...
            <table class="table">
				...
				<td class="text-left">JavaScript, jQuery, CSS, HTML5, Bootstrap</td>
				</tr>
				<tr>
				<td class="text-left">O/S</td>
				<td class="text-left">Windows, Linux<button type="button" class="btn btn-danger">Default</button></td>
				</tr>
				</tbody>
			</table>

		...
		<div class="home-video-wrapper">
			...
			<div class="homevideo-container">
	           <!-- <div id="P1" class="bg-player" style="display:block; margin: auto; background: rgba(0,0,0,0.5)" data-property="{videoURL:'http://youtu.be/mroiVdC7H10',containment:'.homevideo-container', quality: 'hd720', showControls: false, autoPlay:true, mute:true, startAt:0, opacity:1}"></div> -->
				<img src="/resources/img/study.jpg" id="P1" class="bg-player" style="display:block; margin:auto; background: rgba(0,0,0,0.5)">
			</div>
                              ...
                              <div class="container">
                                    <div class="row">
                                          <div class="col-md-2 mob-logo">
                                                <div class="row">
                                                      <div class="site-logo">
                                                            <a href="index.html"><img src="/resources/img/logo-dark.png" alt="" /></a>
                                                      </div>
                                                </div>
                                          </div>
			...
			<div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12" >
                    ...
                    <div id="owl-works" class="owl-carousel">
                        <div class="item"><a href="/resources/img/works/1.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="/resources/img/works/1@2x.jpg"><img src="/resources/img/works/1.jpg" class="img-responsive" alt="img"></a></div>
                        <div class="item"><a href="/resources/img/works/2.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="/resources/img/works/2@2x.jpg"><img src="/resources/img/works/2.jpg" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="/resources/img/works/3.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="/resources/img/works/3@2x.jpg"><img src="/resources/img/works/3.jpg" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="/resources/img/works/4.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="/resources/img/works/4@2x.jpg"><img src="/resources/img/works/4.jpg" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="/resources/img/works/5.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="/resources/img/works/5@2x.jpg"><img src="/resources/img/works/5.jpg" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="/resources/img/works/6.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="/resources/img/works/6@2x.jpg"><img src="/resources/img/works/6.jpg" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="/resources/img/works/7.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="/resources/img/works/7@2x.jpg"><img src="/resources/img/works/7.jpg" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="/resources/img/works/8.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="/resources/img/works/8@2x.jpg"><img src="/resources/img/works/8.jpg" class="img-responsive " alt="img"></a></div>
                    </div>
					</div>
                </div>
            </div>
